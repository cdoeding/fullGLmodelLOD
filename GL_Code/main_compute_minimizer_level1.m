...
% - set initial value in 'get initial values'
...
tol = 10^(-3); % tolerance for termination
i_max = 100000; % maximum number of iterations

save_path = "solution_level1_kappa"+kappa+".mat"; % path for save file
