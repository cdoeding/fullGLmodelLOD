...
if ht_level < h_ref_level
    ...
    % Polongation operator from ref
    [~,T_ht,~,Pt0] = getCoarseFineTriangulation(x_a,x_b,h_ref_level,ht_level);
    [~,~,P2] = getCoarseFineTriangulation_for_P2(T_h_ref,T_ht,Pt0);
    P = P2;

    % polongation
    A1 = Bdx_ht*P'*Bdx_h_ref'*A_ref(1:Nx); % polongation
    A2 = Bdy_ht*P'*Bdy_h_ref'*A_ref(Nx+1:end); % polongation
    A0 = [A1; A2];
