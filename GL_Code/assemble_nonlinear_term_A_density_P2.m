function F = assemble_nonlinear_term_A_density_P2(u,T,T_P1,Nd,nodes2mesh,nodes2mesh_x,nodes2mesh_y,parallel)
%ASSEMBLE_NONLINEAR_TERM_A_DENSITY_P2 Summary of this function goes here
%   Detailed explanation goes here

if parallel
    F = assemble_nonlinear_term_A_density_P2_parallel(u,T,T_P1,Nd,nodes2mesh,nodes2mesh_x,nodes2mesh_y);
else
    F = assemble_nonlinear_term_A_density_P2_sequential(u,T,T_P1,Nd,nodes2mesh,nodes2mesh_x,nodes2mesh_y);
end
end
...
function F = assemble_nonlinear_term_A_density_P2_sequential(u,T,T_P1,Nd,nodes2mesh,nodes2mesh_x,nodes2mesh_y)
...
function F = assemble_nonlinear_term_A_density_P2_parallel(u,T,T_P1,Nd,nodes2mesh,nodes2mesh_x,nodes2mesh_y)
% parallel implementation
Nx = sum(logical(nodes2mesh_x));
dim = sum(logical(nodes2mesh_x)) + sum(logical(nodes2mesh_y));
...
spmd
    ...
    F_worker = sparse(F_i(1:del_index-1),F_j(1:del_index-1),FF(1:del_index-1),dim,dim);
