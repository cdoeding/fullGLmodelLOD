function A = assemble_div_P2(T,Nd,nodes2mesh_x,nodes2mesh_y)
%ASSEMBLE_DIV Summary of this function goes here
    ...
    for i = 1:6
        for j = 1:6
            ...
            if index_i ~= 0 && index_j ~= 0
                a_i(ind) = index_i;
                a_j(ind) = Nx + index_j;
                a(ind) = detBT*evaluateQuadrature(grad_in_BT(1,:,i).*grad_in_BT(2,:,j),w);
                ind = ind + 1;
            end
