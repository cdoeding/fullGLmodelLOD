function Q = getCorrectorMatrixParallel_with_fun(T_H,T_h,T_h_P2,patches,A_h,kappa,beta,S_h,M_h,P1,P0,B_H,B_h,nodes2mesh_x,nodes2mesh_y)
...
spmd
    ...
    for l = my_index_start:my_index_end
        ...
        S_loc = assembleLocalBilinearForm_with_fun(A_h,kappa,T_h,T_h_P2,P0,l,nodes2mesh_x,nodes2mesh_y);
